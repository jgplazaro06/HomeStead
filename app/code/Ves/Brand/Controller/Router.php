...
class Router implements RouterInterface
{
    ...
    public function match(RequestInterface $request)
    {
        ...
        if (!$this->dispatched) {
            ...
            //Check Group Url
            if( (count($identifiers) == 2 && $identifiers[0] == $route) || (trim($route) == '' && count($identifiers) == 1)){
                $brandUrl = '';
                if(trim($route) == '' && count($identifiers) == 1){
                ...
                if (!$url_suffix || ($url_suffix && strpos($identifiers[1], $url_suffix))) {
